...
Текущее продолжение: [C13 — опубликованный phpMyAdmin и проверка истории секретов](C13_PMA_ACTIVATION_AND_HISTORY_SCAN_2026-09-08.md). Публикация phpMyAdmin и скачивание без учётных данных прошли; точный опубликованный образ подтвердил 99 runtime-проверок и 56 проверок состава. Подготовлена замена трёх ссылок PMA с сохранением прежних девяти активаций и исходных образов БД. Для Gitleaks воспроизведены и точечно исправлены 55 history-only совпадений публичных хешей, 36 контрольных проверок прошли. Полный план и выпуск остаются открытыми.

Ниже сохранены исторические срезы C12 и предыдущих этапов; утверждения о публикации и результаты относятся к указанным версиям и времени.
