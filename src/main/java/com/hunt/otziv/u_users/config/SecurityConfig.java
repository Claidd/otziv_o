        ...
        http
                .authorizeHttpRequests((authorizeRequests) ->
                                authorizeRequests
                                        ...
                                        .requestMatchers("/categories/**").hasAnyRole("ADMIN", "OWNER", "MANAGER")
                                        .requestMatchers("/subcategories/**").hasAnyRole("ADMIN", "OWNER", "MANAGER")
                                        .requestMatchers("/operator/**").hasAnyRole("ADMIN", "OWNER", "OPERATOR","MARKETOLOG")
                                        .requestMatchers("/companies/**").hasAnyRole("ADMIN", "OWNER", "MANAGER")
