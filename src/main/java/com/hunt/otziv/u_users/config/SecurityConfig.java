...
//                                        .requestMatchers("/api/index2").permitAll()
                                        .requestMatchers("/lead/new_lead").hasAnyRole("ADMIN", "CALLING","MARKETOLOG")
                                        .requestMatchers("/").authenticated()
                                        .requestMatchers("/allUsers/**").hasRole("ADMIN")
                                        .requestMatchers("/lead/**").hasAnyRole("ADMIN", "CALLING","MARKETOLOG")
                                        ...
                                        .requestMatchers("/operator/**").hasAnyRole("ADMIN", "CALLING","MARKETOLOG")
                                        ...
                                        .requestMatchers("/worker/**").hasAnyRole("ADMIN","MANAGER","WORKER")
