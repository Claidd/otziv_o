...
Assert-Order $observerRollout 'compose build docker-observer' 'recreate_service_with_retry docker-observer' 'Each deploy must build the current observer before recreation.'
