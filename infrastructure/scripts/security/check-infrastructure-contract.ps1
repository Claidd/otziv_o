...
Assert-TextMatch $smoke 'MIGRATIONS=16[\s\S]{0,1000}HARDENING_MIGRATIONS=5[\s\S]{0,1000}FUTURE_EXPIRY_EVENTS=0[\s\S]{0,10000}ROLLOUT_LEGACY=1[\s\S]{0,10000}LIVE_ALLOCATIONS=0[\s\S]{0,10000}GENERATION_COLLATIONS=5[\s\S]{0,10000}live_master=false[\s\S]{0,500}reward_master=false' 'Contractor payment smoke must prove V217-V232 and all financial hardening migrations through V249, expiry-event timeline integrity, one-way rollout in LEGACY, collation-safe generation joins, and closed database/deployment LIVE gates.'
