...
Assert-TextMatch $backendDockerfile 'COPY backend/docker/certs/russian_trusted_root_ca\.crt' 'The backend image must copy the pinned Russian Trusted Root CA from the reactor build context.'
