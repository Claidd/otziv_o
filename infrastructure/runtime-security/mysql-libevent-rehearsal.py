...
OLD = 'ghcr.io/claidd/otziv-security@sha256:d626770288635060a3b150872e75888c2890d7a580392f04c8924a8071bd1a2d'
...
def run(args):
    ...
    try:
        for key,image in [('source',OLD),('candidate',args.candidate)]:
            ...
            result[key+'OtherPackagesSha256']=sha(('\n'.join(sorted(x for x in packages if not x.startswith('libevent-')))).encode())
        ...
        check('only_libevent_changed',result['sourceOtherPackagesSha256']==result['candidateOtherPackagesSha256'])
