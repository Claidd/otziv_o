...
RUN --mount=type=cache,id=otziv-monitoring-go-mod,target=/go/pkg/mod,sharing=locked \
    ...
    && go build -mod=readonly -p 2 -trimpath -buildvcs=true -tags kqueue \
      -ldflags '-s -w -X github.com/minio/mc/cmd.Version=2025-11-06T16:25:29Z -X github.com/minio/mc/cmd.ReleaseTag=RELEASE.2025-11-06T16-25-29Z.otziv-c15.1 -X github.com/minio/mc/cmd.CommitID=77f82e18b5401a65958f1619df6ebb994634bd88 -X github.com/minio/mc/cmd.ShortCommitID=77f82e18b540' \
      -o /out/mc . \
...
LABEL org.opencontainers.image.source="https://github.com/Claidd/otziv_o" \
      ...
      org.opencontainers.image.version="RELEASE.2025-11-06T16-25-29Z.otziv-c15.1" \
