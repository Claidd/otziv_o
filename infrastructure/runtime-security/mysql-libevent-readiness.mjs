...
import {validateDatabaseTransitionReadiness as original} from './mysql-refresh-readiness.mjs';
import {summarizeReport,TRIVY_IMAGE} from './scan.mjs';
import {buildTriage} from './triage-report.mjs';
export const MYSQL_REFRESH_REFERENCE='ghcr.io/claidd/otziv-security@sha256:c810a0bd4902a4791824bce7795f95f97743506a4263889a1008076e6e9630b0';
export const MYSQL_REFRESH_CONFIG='sha256:e120bacdf41531660cd96bb43d06c9444c629d2115c4a4aa1ba97f864d2bf21b';
export const MYSQL_REFRESH_REHEARSAL_SHA256='ffd87e67cf3bcfbc3c42f78d954f06b1d07c35d265db04add073c351198d1700';
const ROOT='infrastructure/runtime-security/proofs/c18-mysql/';
...
export async function validateDatabaseTransitionReadiness(entry,image,read){
  ...
  assert.equal(rehearsal.executedSourceSha256,hash(await read('infrastructure/runtime-security/mysql-libevent-rehearsal.py')),'mysql_refresh_executed_source');
  ...
  for(const name of ['engine_version_source','engine_version_candidate','server_binary_unchanged','openssl_fixed','libevent_fixed','only_libevent_changed',
  ...
  assert.equal(publication.manifestSet,'c18-mysql','mysql_refresh_publication_set');
