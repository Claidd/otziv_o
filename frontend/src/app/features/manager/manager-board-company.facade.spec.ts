...
function companyPayload(overrides: Partial<CompanyEditPayload> = {}): CompanyEditPayload {
  return {
    ...
    phones: '+79990000000',
    mobilePhones: '+79991111111',
    whatsappPhones: '+79992222222',
    emails: 'company@example.test',
    websites: 'https://company.example.test',
    vkUrl: 'https://vk.example.test/company',
    telegramUrl: 'https://t.me/company',
    region: 'Region',
    address: 'Address',
    industries: 'Industry',
    companyType: 'Type',
