...
describe('apiErrorMessage', () => {
  ...
  it('shows the concrete API endpoint when a 403 remains after token refresh', () => {
    expect(apiErrorMessage({
      ...
      'Менеджер не загрузился. API /api/manager/board отклонил запрос (403). Сервер не разрешил доступ к этому разделу. Проверьте права вашей роли или обратитесь к администратору.'
    );
  });
