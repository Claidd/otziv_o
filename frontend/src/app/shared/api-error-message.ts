...
function statusErrorDetail(err: unknown): string | null {
  ...
  if (status === 403) {
    ...
    return endpoint
      ? `API ${endpoint} отклонил запрос (403). Сервер не разрешил доступ к этому разделу. Проверьте права вашей роли или обратитесь к администратору.`
      : 'API отклонил запрос (403). Сервер не разрешил доступ к этому разделу. Проверьте права вашей роли или обратитесь к администратору.';
  }
