...
class WorkloadShadowRecipientHistoryQueryContractTest {
    ...
    @Test
    void freezeCreditsUseTheSamePreservedDailyAchievement() throws Exception {
        Method method = WorkloadShadowProjectionRepository.class.getDeclaredMethod(
        ...
        assertThat(sql).contains("daily.reached_100_once as reached_100");
        assertThat(sql).doesNotContain("daily.reached_100,");
    }
}
