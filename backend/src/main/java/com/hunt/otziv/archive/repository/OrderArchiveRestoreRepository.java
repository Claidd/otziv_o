...
public class OrderArchiveRestoreRepository {
    ...
    public boolean isAlreadyRestored(Long orderId) {
    ...
    public ArchiveCandidateCounts countArchiveRows(Long orderId) {
    ...
    public ArchiveCandidateCounts countLiveConflicts(Long orderId) {
        return new ArchiveCandidateCounts(
                count("""
                        SELECT COUNT(*)
                        FROM orders o
    ...
    public ArchiveCandidateCounts restoreOrder(Long orderId, Long targetStatusId) {
    ...
    public Long insertRestoreBatch(
            Long orderId,
    ...
    public void markArchiveOrderRestored(Long orderId, Long restoreBatchId, LocalDateTime restoredAt, String restoredBy) {
        jdbc.update("""
