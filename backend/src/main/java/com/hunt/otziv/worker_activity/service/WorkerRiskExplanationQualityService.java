...
public class WorkerRiskExplanationQualityService {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            «Аккаунт заблокирован» может означать блокировку внешней площадкой.
            Кнопка «Блок» в нашей системе лишь отмечает такой аккаунт неактивным и заменяет его.
            Копирование логина и пароля для проверки входа, обнаружение внешней блокировки и затем
            нажатие «Блок» — согласованная последовательность, а не противоречие.
            Само копирование не доказывает успешный вход и не опровергает внешнюю блокировку.
            Отсутствие события в ограниченной выборке recentWorkerActivity не доказывает отсутствия действия.
            Не называй объяснение противоречивым или ложным только по этим основаниям.
