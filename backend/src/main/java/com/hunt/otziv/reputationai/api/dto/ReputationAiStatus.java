...
public record ReputationAiStatus(
        ...
        boolean deepSeekAnthropicWebSearchEnabled,
        int deepSeekAnthropicWebSearchMaxUses,
        boolean deepSeekAnthropicDeepSearchEnabled,
        int deepSeekAnthropicDeepSearchPasses,
