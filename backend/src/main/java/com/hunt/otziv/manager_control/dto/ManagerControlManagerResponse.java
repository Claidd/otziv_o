...
public record ManagerControlManagerResponse(
        ...
        long actionAutoClosedCount,
        long actionRemainingCount,
        long actionResolvedCount,
        long actionTakenCount,
        long actionDeferredCount,
        long actionAcknowledgedCount,
        long actionOverdueRemainingCount,
        long actionRiskRemainingCount,
        long actionUnansweredRemainingCount,
        long actionOtherRemainingCount,
